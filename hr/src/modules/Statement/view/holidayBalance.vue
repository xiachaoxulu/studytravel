...
* @Last Modified time : 2016-11-24T16:04:22+08:00
 -->
...
<div style="background: #fff;">
    ...
    <div class="wrap">
        <ui-report v-ref:report :data-list="state.employeeVacationBalanceReportList" :titles="titles" :multi-titles="multiTitles" :row-total="rowTotal" :column-total="columnTotal" :group-infos="groupColumns" :total-ignore='totalIgnore' :progress-show="processShow"
...
export default {
    data() {
        return {
            ...
            multiTitles: [{
                title: '年假',
                columns: ['yearTotal', 'yearUse', 'yearBalance']
            }, {
                title: '事假',
                columns: ['thingUse']
            }, {
        ...
        loadData(userName) {
            ...
            if (store.actions.checkConditions()) {
                if (self.state.flag) {
                    ...
                    store.actions.loadEmployeeVacationBalanceReport(function(data) {
                        self.rowTotal = true;
