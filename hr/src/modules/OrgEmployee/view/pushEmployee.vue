...
* @Last Modified time : 2016-12-20T16:20:43+08:00
 -->
<template>
      ...
      <form class="form-horizontal container-fluid warp" role="form" vali-submit="submitBt|submitInfo">
        ...
        <div class="photo-wrap">
              ...
              <div class="col-sm-24">
                <div class="form-group   row">
                  <template v-if="tableColumnList['userName'] == 1">
                    ...
                    <div class="col-sm-16">
                      <input type="text" v-model="info.employee.userName" class="form-control" placeholder="请输入员工姓名">
                    </div>
                  </template>
                  <template v-else>
                    <label class="col-sm-8 control-label"><span class="must">*</span>姓名</label>
                    <div class="col-sm-16">
                      <input type="text" v-model="info.employee.userName" class="form-control" placeholder="请输入员工姓名" vali="required" vali-msg='必填项'>
                    </div>
                  </template>
                </div>
              </div>
              ...
              <div class="col-sm-24">
                <div class="form-group   row">
                  <template v-if="tableColumnList['country'] == 1">
                    ...
                    <div class="col-sm-16">
                      <select v-model="info.employee.country" class="form-control">
                  ...
                  <template v-else>
                    ...
                    <div class="col-sm-16">
                      <select v-model="info.employee.country" class="form-control" vali="required" vali-msg='必填项'>
                        <option value="">请选择国籍</option>
                        <template v-for="item in countrys">
                          <option value="{{item.code}}" :selected="item.code==info.employee.country">{{item.codeName}}</option>
                        </template>
              ...
              <div class="col-sm-24">
                <div class="form-group   row">
                  <template v-if="tableColumnList['idCardType'] == 1">
                    ...
                    <div class="col-sm-16">
                      <select v-model="info.employee.idCardType" class="form-control">
                  ...
                  <template v-else>
                    ...
                    <div class="col-sm-16">
                      <select v-model="info.employee.idCardType" class="form-control" vali="required" vali-msg='必填项'>
                        <option value="">请选择证件类型</option>
                        <template v-for="item in idCardTypes">
                          <option value="{{item.code}}" :selected="item.code==info.employee.idCardType">{{item.codeName}}</option>
                        </template>
              ...
              <div class="col-sm-24">
                <div class="form-group   row">
                  <template v-if="tableColumnList['userIDCard'] == 1">
                    ...
                    <div class="col-sm-16">
                      <input type="text" v-model="info.employee.userIDCard" class="form-control" placeholder="请输入证件号码" readonly="{{info.employee.idCardType == ''}}" @input="IDChange">
                    </div>
                  </template>
                  <template v-else>
                    <label class="col-sm-8 control-label"><span class="must">*</span>证件号码</label>
                    <div class="col-sm-16">
                      <input type="text" v-model="info.employee.userIDCard" class="form-control" placeholder="请输入证件号码" vali="required" vali-msg='必填项' readonly="{{info.employee.idCardType == ''}}" @input="IDChange">
                    </div>
                  </template>
                </div>
              </div>
              ...
              <div class="col-sm-24">
                <div class="form-group row">
                  <template v-if="tableColumnList['birthDay'] == 1">
                    ...
                    <div class="col-sm-16">
                      <ui-datepicker :disabled="info.employee.idCardType == '149001'" :time.sync="info.employee.birthDay" format="yyyy-MM-dd" width="232px"></ui-datepicker>
                    </div>
                  </template>
                  <template v-else>
                    <label class="col-sm-8 control-label"><span class="must">*</span>出生日期</label>
                    <div class="col-sm-16">
                      <ui-datepicker :disabled="info.employee.idCardType == '149001'" :time.sync="info.employee.birthDay" format="yyyy-MM-dd" width="232px" vali="required" vali-msg='必填项'></ui-datepicker>
                    </div>
                  </template>
                </div>
              </div>
          ...
          <div class="photo-wrap-right">
            <img v-if="info.employee.photourl==''" src="../../../assets/images/avatar.png" class="img">
            <img v-else :src="info.employee.photourl" class="img">
          </div>
          <div class="photo-wrap-attach">
            <a href="javascript:void(0)" @click="uploadImg">+上传附件</a>
          </div>
        </div>
        <div class="row">
          <div class="col-sm-12">
            <div class="form-group   row">
              <template v-if="tableColumnList['hukouAddress'] == 0">
                ...
                <div class="col-sm-16">
                  <input type="text" v-model="info.employee.hukouAddress" class="form-control" placeholder="请输入户口所在地" vali="required" vali-msg='必填项'>
                </div>
              </template>
              <template v-else>
                <label class="col-sm-8 control-label">户口所在地</label>
                <div class="col-sm-16">
                  <input type="text" v-model="info.employee.hukouAddress" class="form-control" placeholder="请输入户口所在地">
                </div>
              </template>
            </div>
          </div>
          <div class="col-sm-12">
            <div class="form-group  row">
              <template v-if="tableColumnList['userNum'] == 1">
                ...
                <div class="col-sm-16">
                  <input type="text" v-model="info.employee.userNum" class="form-control" placeholder="请输入员工编码" readonly="{{employeeID!==''}}">
                </div>
              </template>
              <template v-else>
                <label class="col-sm-8 control-label"><span class="must">*</span>员工工号</label>
                <div class="col-sm-16">
                  <input type="text" v-model="info.employee.userNum" class="form-control" placeholder="请输入员工编码" vali="required" vali-msg='必填项' readonly="{{employeeID!==''}}">
                </div>
              </template>
            </div>
          </div>
          ...
          <div class="col-sm-12">
            <div class="form-group   row">
              <template v-if="tableColumnList['isMarried'] == 0">
                ...
                <div class="col-sm-16">
                  <select v-model="info.employee.isMarried" class="form-control" vali="required" vali-msg='必填项'>
              ...
              <template v-else>
                ...
                <div class="col-sm-16">
                  <select v-model="info.employee.isMarried" class="form-control">
                    <option value="">请选择婚姻状况</option>
                    <template v-for="item in marriedtypes">
                      <option value="{{item.code}}" :selected="item.code==info.employee.isMarried">{{item.codeName}}</option>
                    </template>
          ...
          <div class="col-sm-12">
            <div class="form-group   row">
              <template v-if="tableColumnList['gender'] == 1">
                ...
                <div class="col-sm-16">
                  <select v-model="info.employee.gender" class="form-control">
              ...
              <template v-else>
                ...
                <div class="col-sm-16">
                  <select v-model="info.employee.gender" class="form-control" vali="required" vali-msg='必填项'>
                    <option value="">请选择性别</option>
                    <template v-for="item in genders">
                      <option value="{{item.code}}" :selected="item.code==info.employee.gender">{{item.codeName}}</option>
                    </template>
          ...
          <div class="col-sm-12">
            <div class="form-group  row">
              <template v-if="tableColumnList['dormistory'] == 0">
                ...
                <div class="col-sm-16">
                  <div class="choose-input" @click="selectDormitory">
                    <input readonly type="text" v-model="info.dormitory.address" class="form-control" placeholder="请选择员工宿舍" vali="required" vali-msg='必填项'>
              ...
              <template v-else>
                ...
                <div class="col-sm-16">
                  <div class="choose-input" @click="selectDormitory">
                    <input readonly type="text" v-model="info.dormitory.address" class="form-control" placeholder="请选择员工宿舍">
                    <i class="icon-tool-search icon-tool"></i>
                  </div>
                </div>
              </template>
          ...
          <div class="col-sm-12">
            <div class="form-group  row">
              <template v-if="tableColumnList['nation'] == 0">
                ...
                <div class="col-sm-16">
                  <select v-model="info.employee.nation" class="form-control" vali="required" vali-msg='必填项'>
              ...
              <template v-else>
                ...
                <div class="col-sm-16">
                  <select v-model="info.employee.nation" class="form-control">
                    <option value="">请选择民族</option>
                    <template v-for="item in nations">
                      <option value="{{item.code}}" :selected="item.code==info.employee.nation">{{item.codeName}}</option>
                    </template>
          ...
          <div class="col-sm-12">
            <div class="form-group  row">
              <template v-if="tableColumnList['hukouType'] == 0">
                ...
                <div class="col-sm-16">
                  <select v-model="info.employee.hukouType" class="form-control" vali="required" vali-msg='必填项'>
              ...
              <template v-else>
                ...
                <div class="col-sm-16">
                  <select v-model="info.employee.hukouType" class="form-control">
                    <option value="">请选择户口类型</option>
                    <template v-for="item in hukoutypes">
                      <option value="{{item.code}}" :selected="item.code==info.employee.hukouType">{{item.codeName}}</option>
                    </template>
          ...
          <div class="col-sm-12">
            <div class="form-group   row">
              <template v-if="tableColumnList['healthEndTime'] == 1">
                ...
                <div class="col-sm-16">
                  <ui-datepicker :time.sync="info.employee.healthEndTime" format="yyyy-MM-dd" width="232px"></ui-datepicker>
                </div>
              </template>
              <template v-else>
                <label class="col-sm-8 control-label"><span class="must">*</span>健康证</label>
                <div class="col-sm-16">
                  <ui-datepicker :time.sync="info.employee.healthEndTime" format="yyyy-MM-dd" width="232px" vali="required" vali-msg='必填项'></ui-datepicker>
                </div>
              </template>
            </div>
          </div>
          ...
          <div class="col-sm-12">
            <div class="form-group  row">
              <template v-if="tableColumnList['bankName'] == 1">
                ...
                <div class="col-sm-16">
                  <select v-model="info.employee.bankName" class="form-control">
              ...
              <template v-else>
                ...
                <div class="col-sm-16">
                  <select v-model="info.employee.bankName" class="form-control" vali="required" vali-msg='必填项'>
                    <option value="">请选择发卡银行</option>
                    <template v-for="item in banks">
                      <option value="{{item.code}}" :selected="item.code==info.employee.bankName">{{item.codeName}}</option>
                    </template>
          ...
          <div class="col-sm-12">
            <div class="form-group   row">
              <template v-if="tableColumnList['bankCard'] == 1">
                ...
                <div class="col-sm-16">
                  <input type="text" v-model="info.employee.bankCard" class="form-control" placeholder="请输入银行卡号">
                </div>
              </template>
              <template v-else>
                <label class="col-sm-8 control-label"><span class="must">*</span>银行卡号</label>
                <div class="col-sm-16">
                  <input type="text" v-model="info.employee.bankCard" class="form-control" placeholder="请输入银行卡号" vali="required|maxStr:50" vali-msg='必填项||最大长度50'>
                </div>
              </template>
            </div>
          </div>
          ...
          <div class="col-sm-12">
            <div class="form-group  row">
              <template v-if="tableColumnList['phone'] == 0">
                ...
                <div class="col-sm-16">
                  <input type="text" vali="required|format:mobile" vali-msg='必填项|手机号错误' v-model="info.employee.phone" class="form-control" placeholder="请输入手机号">
                </div>
              </template>
              <template v-else>
                <label class="col-sm-8 control-label">手机号</label>
                <div class="col-sm-16">
                  <input type="text" vali="format:mobile" vali-msg='手机号错误' v-model="info.employee.phone" class="form-control" placeholder="请输入手机号">
                </div>
              </template>
            </div>
          </div>
          <div class="col-sm-12">
            <div class="form-group   row">
              <template v-if="tableColumnList['weChat'] == 0">
                ...
                <div class="col-sm-16">
                  <input type="text" vali="required" vali-msg='必填项' v-model="info.employee.weChat" class="form-control" placeholder="请输入微信">
                </div>
              </template>
              <template v-else>
                <label class="col-sm-8 control-label">微信</label>
                <div class="col-sm-16">
                  <input type="text" v-model="info.employee.weChat" class="form-control" placeholder="请输入微信">
                </div>
              </template>
            </div>
          </div>
          ...
          <div class="col-sm-12">
            <div class="form-group  row">
              <template v-if="tableColumnList['mail'] == 0">
                ...
                <div class="col-sm-16">
                  <input type="text" v-model="info.employee.mail" vali="required|format:email" vali-msg="必填项|email格式错误" class="form-control" placeholder="请输入邮箱">
                </div>
              </template>
              <template v-else>
                <label class="col-sm-8 control-label">邮箱</label>
                <div class="col-sm-16">
                  <input type="text" v-model="info.employee.mail" vali="format:email" vali-msg="email格式错误" class="form-control" placeholder="请输入邮箱">
                </div>
              </template>
            </div>
          </div>
          <div class="col-sm-12">
            <div class="form-group   row">
              <template v-if="tableColumnList['qq'] == 0">
                ...
                <div class="col-sm-16">
                  <input type="text" v-model="info.employee.qq" class="form-control" placeholder="请输入QQ号" vali="required" vali-msg='必填项'>
                </div>
              </template>
              <template v-else>
                <label class="col-sm-8 control-label">QQ号</label>
                <div class="col-sm-16">
                  <input type="text" v-model="info.employee.qq" class="form-control" placeholder="请输入QQ号">
                </div>
              </template>
            </div>
          </div>
          ...
          <div class="col-sm-12">
            <div class="form-group   row">
              <template v-if="tableColumnList['urgentPerson'] == 0">
                ...
                <div class="col-sm-16">
                  <input type="text" v-model="info.employee.urgentPerson" class="form-control" placeholder="请输入紧急联系人" vali="required" vali-msg='必填项'>
                </div>
              </template>
              <template v-else>
                <label class="col-sm-8 control-label">紧急联系人</label>
                <div class="col-sm-16">
                  <input type="text" v-model="info.employee.urgentPerson" class="form-control" placeholder="请输入紧急联系人">
                </div>
              </template>
            </div>
          </div>
          <div class="col-sm-12">
            <div class="form-group   row">
              <template v-if="tableColumnList['urgentPhone'] == 0">
                ...
                <div class="col-sm-16">
                  <input type="text" v-model="info.employee.urgentPhone" class="form-control" placeholder="请输入联系电话" vali="required" vali-msg='必填项'>
                </div>
              </template>
              <template v-else>
                <label class="col-sm-8 control-label">联系电话</label>
                <div class="col-sm-16">
                  <input type="text" v-model="info.employee.urgentPhone" class="form-control" placeholder="请输入联系电话">
                </div>
              </template>
            </div>
          </div>
          ...
          <div class="col-sm-12">
            <div class="form-group  row">
              <template v-if="tableColumnList['userType'] == 1">
                ...
                <div class="col-sm-16">
                  <select v-model="info.employee.userType" class="form-control">
              ...
              <template v-else>
                ...
                <div class="col-sm-16">
                  <select v-model="info.employee.userType" class="form-control" vali="required" vali-msg='必填项'>
                    <option value="">请选择用工类型</option>
                    <template v-for="item in userTypes">
                      <option value="{{item.code}}" :selected="item.code==info.employee.userType">{{item.codeName}}</option>
                    </template>
          ...
          <div class="col-sm-12">
            <div class="form-group   row">
              <template v-if="tableColumnList['firstWorkTime'] == 0">
                ...
                <div class="col-sm-16">
                  <ui-datepicker :time.sync="info.employee.firstWorkTime" format="yyyy-MM-dd" width="232px" vali="required" vali-msg='必填项'></ui-datepicker>
                </div>
              </template>
              <template v-else>
                <label class="col-sm-8 control-label">首次工作日期</label>
                <div class="col-sm-16">
                  <ui-datepicker :time.sync="info.employee.firstWorkTime" format="yyyy-MM-dd" width="232px"></ui-datepicker>
                </div>
              </template>
            </div>
          </div>
          ...
          <div class="col-sm-12">
            <div class="form-group  row">
              <template v-if="tableColumnList['deptID'] == 1">
                ...
                <div class="col-sm-16">
                  <combo-tree :treedata="org" :multiple="false" idprop="ID" :rootvisible="false" :nodeclicked="nodeClicked" :enabledrop="employeeID=='' || second">
          ...
          <div class="col-sm-12">
            <div class="form-group  row">
              <template v-if="tableColumnList['postID'] == 1">
                ...
                <div class="col-sm-16">
                  <combo-tree :treedata="postTree" :multiple="false" idprop="ID" textprop="postName" :enabledrop="employeeID=='' || second " :rootvisible="false" :nodeclicked="postnodeClicked">
                    <div data-toggle="dropdown">
                      <div class="choose-input">
                        <input type="text" class="form-control" v-model="postDisplayName" placeholder="请选择岗位" readonly @focus="orgfocus">
                        <i class="icon-tool-search icon-tool"></i>
                      </div>
                    </div>
                  </combo-tree>
              ...
              <template v-else>
                ...
                <div class="col-sm-16">
                  <combo-tree :treedata="postTree" :multiple="false" idprop="ID" textprop="postName" :enabledrop="employeeID=='' || second " :rootvisible="false" :nodeclicked="postnodeClicked">
                    <div data-toggle="dropdown">
                      <div class="choose-input">
                        <input type="text" class="form-control" vali="required" vali-msg='必填项' v-model="postDisplayName" placeholder="请选择岗位" readonly @focus="orgfocus">
                        <i class="icon-tool-search icon-tool"></i>
                      </div>
                    </div>
                  </combo-tree>
          ...
          <div class="col-sm-12">
            <div class="form-group   row">
              <template v-if="tableColumnList['rankID'] == 1">
                ...
                <div class="col-sm-16">
                  <select v-bind:disabled="employeeID!='' && !second" v-model="info.employee.rankID" class="form-control">
              ...
              <template v-else>
                ...
                <div class="col-sm-16">
                  <select v-bind:disabled="employeeID!='' && !second" v-model="info.employee.rankID" class="form-control" vali="required" vali-msg='必填项'>
                    <option value="">请选择职级</option>
                    <template v-for="item in ranks">
                      <option value="{{item.ID}}" :selected="item.ID==info.employee.rankID">{{item.rankName}}</option>
                    </template>
          ...
          <div class="col-sm-12">
            <div class="form-group  row">
              <template v-if="tableColumnList['startTime'] == 1">
                ...
                <div class="col-sm-16">
                  <ui-datepicker :time.sync="info.employee.startTime" format="yyyy-MM-dd" width="232px"></ui-datepicker>
                </div>
              </template>
              <template v-else>
                <label class="col-sm-8 control-label"><span class="must">*</span>入职日期</label>
                <div class="col-sm-16">
                  <ui-datepicker :time.sync="info.employee.startTime" format="yyyy-MM-dd" width="232px" vali="required" vali-msg='必填项'></ui-datepicker>
                </div>
              </template>
            </div>
          </div>
          ...
          <div class="col-sm-12">
            <div class="form-group   row">
              <template v-if="tableColumnList['offerTime'] == 0">
                ...
                <div class="col-sm-16">
                  <ui-datepicker :time.sync="info.employee.offerTime" format="yyyy-MM-dd" width="232px" vali="required" vali-msg='必填项'></ui-datepicker>
                </div>
              </template>
              <template v-else>
                <label class="col-sm-8 control-label">转正日期</label>
                <div class="col-sm-16">
                  <ui-datepicker :time.sync="info.employee.offerTime" format="yyyy-MM-dd" width="232px"></ui-datepicker>
                </div>
              </template>
            </div>
          </div>
          <div class="col-sm-12">
            <div class="form-group  row">
              <template v-if="tableColumnList['expiryDate'] == 0">
                ...
                <div class="col-sm-16">
                  <ui-datepicker :time.sync="info.employee.expiryDate" format="yyyy-MM-dd" width="232px" vali="required" vali-msg='必填项'></ui-datepicker>
                </div>
              </template>
              <template v-else>
                <label class="col-sm-8 control-label">合同到期日</label>
                <div class="col-sm-16">
                  <ui-datepicker :time.sync="info.employee.expiryDate" format="yyyy-MM-dd" width="232px"></ui-datepicker>
                </div>
              </template>
            </div>
          </div>
          ...
          <div class="col-sm-12">
            <div class="form-group   row">
              <template v-if="tableColumnList['checkworkcode'] == 0">
                ...
                <div class="col-sm-16">
                  <input type="text" v-bind:disabled="type==2" v-model="info.employee.checkworkcode" class="form-control" vali="required|maxStr:45" vali-msg="必填项|最大长度45" placeholder="请输入考勤卡号">
                </div>
              </template>
              <template v-else>
                <label class="col-sm-8 control-label">考勤卡号</label>
                <div class="col-sm-16">
                  <input type="text" v-bind:disabled="type==2" v-model="info.employee.checkworkcode" class="form-control" vali="maxStr:45" vali-msg="最大长度45" placeholder="请输入考勤卡号">
                </div>
              </template>
            </div>
          </div>
          ...
          <div class="col-sm-12">
            <div class="form-group  row">
              <template v-if="tableColumnList['checkworkid'] == 1">
                ...
                <div class="col-sm-16">
                  <select v-model="info.employee.checkworkid" class="form-control">
              ...
              <template v-else>
                ...
                <div class="col-sm-16">
                  <select v-model="info.employee.checkworkid" class="form-control" vali="required" vali-msg='必填项'>
                    <option value="">请选择考勤规则</option>
                    <template v-for="item in rules">
                      <option value="{{item.ID}}" :selected="item.ID==info.employee.checkworkid">{{item.checkworkName}}</option>
                    </template>
...
export default {
  data() {
    ...
    events: {
      ...
      submitInfo() {
        ...
        if (self.employeeID == "") {
          ...
          copyInfo.dormitory=this.info.dormitory;
          copyInfo.extendList=this.info.extendList;
          store.actions.updateEmployeeEntry(copyInfo, function(data) {
            self.$refs.spinner.hide();
            var msg = "";
            if (self.second) {
              msg = "重新加入成功";
    ...
    ready() {
      console.log(this.info.extendList);
      var self = this;
      if (self.employeeID != "") {
        //加载个人详细信息
        store.actions.getOneEmployeeEntryInfo(self.employeeID, function(data) {
      ...
      store.actions.getExtendEntryInfo({
        id: this.employeeID
      }, function(data) {
        console.log(data);
        ...
        console.log(self.info.extendList)
      }, function(error) {
        self.$root.showTip({
          type: 'danger',
          msg: error,
