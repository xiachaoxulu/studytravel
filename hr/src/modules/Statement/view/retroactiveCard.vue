...
* @Last Modified time : 2016-11-14T15:31:57+08:00
 -->
...
<div style="background: #fff;">
    ...
    <div class="wrap">
        <ui-report v-ref:report  :data-list="state.attenCardDataList" :titles="titles" :multi-titles="multiTitles" :row-total="rowTotal" :group-infos="groupColumns" :total-ignore='totalIgnore' :td-height="70" :progress-show="processShow"
            :lorder="lorder">
        </ui-report>
    ...
    methods: {
        ...
        loadData(userName) {
            ...
            if (userName) {
                ...
                store.actions.loadCardReportData(function(data) {
                    self.rowTotal = true;
            ...
            if (store.actions.checkConditions()) {
                if (this.state.flag) {
                    ...
                    this.$nextTick(function() {
                        ...
                        window.location.href = Vue.__Basepath + 'acewill/common/exportRetroactiveCardReport.htm?' + param;
                    })
                }
            }
        }
