...
export default {
  data() {
      return {
        ...
        url: 'api.Dashboard.getHealthData',
    ...
    methods: {
      exportExcel() {
        ...
        this.$root.downloadFile('acewill/common/card/exporthealthcardwarning.htm',param);
      },
      searchAtt() {
        this.refreshTable();
      },
