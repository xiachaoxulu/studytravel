      ...
      <main class="main-content">
        <div class="toolbar">
          <div class="quick-info">
            <strong>加班工时限额人数&nbsp;&nbsp;{{total}}&nbsp;&nbsp;人</strong>
          </div>
...
export default {
  data() {
      return {
        ...
        url: 'api.Dashboard.getOverTimeLimit',
        ...
        fields: [{
          ...
          formater: function(value, data, index) {
            if (data.overtimeRule == "5") {
              ...
              if (!isNaN(data.overtimeLimitTime) && !isNaN(data.moreWork)) {

                return ((data.overtimeLimitTime - 0) - (data.moreWork - 0)).toFixed(2);
              } else {
                return 'N/A';
              }
            }
    ...
    methods: {
      exportExcel() {
        ...
        this.$root.downloadFile('acewill/common/card/exportovertimelimitpage.htm', param);
      },
      searchAtt() {
        this.refreshTable();
      },
