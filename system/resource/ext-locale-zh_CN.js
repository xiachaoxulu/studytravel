Ext.onReady(function() {
    ...
    if (Ext.util && Ext.util.Format) { Ext.apply(Ext.util.Format, { thousandSeparator: ",", decimalSeparator: ".", currencySign: "\u00a5", dateFormat: "y年m月d日" }) }
});
...
Ext.define("Ext.locale.zh_CN.form.field.ComboBox", { override: "Ext.form.field.ComboBox", valueNotFoundText: undefined }, function() { Ext.apply(Ext.form.field.ComboBox.prototype.defaultListConfig, { loadingText: "加载中..." }) });
...
Ext.define("Ext.locale.zh_CN.panel.Panel.closeToolText", { override: "Ext.panel.Panel", closeToolText: "关闭",collapseToolText:'收缩',expandToolText:'展开' });
