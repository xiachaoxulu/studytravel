<template>
  <ui-modal :show.sync="display" header="修改员工录入信息" type="large" hide-footer>
          ...
          <div class="col-sm-12">
            <div class="form-group  row">
              <template v-if="tableColumnList['userNum'] == 1">
                ...
                <div class="col-sm-16">
                  <input type="text" v-model="info.employee.userNum" class="form-control" placeholder="请输入员工编码">
                </div>
              </template>
              <template v-else>
                <label class="col-sm-8 control-label"><span class="must">*</span>员工工号</label>
                <div class="col-sm-16">
                  <input type="text" v-model="info.employee.userNum" class="form-control" placeholder="请输入员工编码" vali="required" vali-msg='必填项'>
                </div>
              </template>
            </div>
          </div>
              ...
              <template v-else>
                ...
                <div class="col-sm-16">
                  <combo-tree :treedata="org" :multiple="false" idprop="ID" :rootvisible="false" :nodeclicked="nodeClicked">
                    <div data-toggle="dropdown">
                      <div class="choose-input">
                        <input type="text" class="form-control" v-model="orgDisplayName" placeholder="请选择组织" vali="required" vali-msg='必填项' readonly>
                        <i class="icon-tool-search icon-tool"></i>
                      </div>
                    </div>
                  </combo-tree>
              ...
              <template v-if="tableColumnList['postID'] == 1">
                ...
                <div class="col-sm-16">
                  <combo-tree :treedata="postTree" :multiple="false" idprop="ID" textprop="postName" :rootvisible="false" :nodeclicked="postnodeClicked">
                    <div data-toggle="dropdown">
                      <div class="choose-input">
                        <input type="text" class="form-control" v-model="postDisplayName" placeholder="请选择岗位" readonly>
                        <i class="icon-tool-search icon-tool"></i>
                      </div>
                    </div>
                  </combo-tree>
              ...
              <template v-else>
                ...
                <div class="col-sm-16">
                  <combo-tree :treedata="postTree" :multiple="false" idprop="ID" textprop="postName" :rootvisible="false" :nodeclicked="postnodeClicked">
                    <div data-toggle="dropdown">
                      <div class="choose-input">
                        <input type="text" class="form-control" vali="required" vali-msg='必填项' v-model="postDisplayName" placeholder="请选择岗位" readonly>
                        <i class="icon-tool-search icon-tool"></i>
                      </div>
                    </div>
                  </combo-tree>
          ...
          <div class="col-sm-12">
            <div class="form-group   row">
              <template v-if="tableColumnList['rankID'] == 1">
                ...
                <div class="col-sm-16">
                  <select v-model="info.employee.rankID" class="form-control">
              ...
              <template v-else>
                ...
                <div class="col-sm-16">
                  <select v-model="info.employee.rankID" class="form-control" vali="required" vali-msg='必填项'>
                    <option value="">请选择职级</option>
                    <template v-for="item in ranks">
                      <option value="{{item.ID}}" :selected="item.ID==info.employee.rankID">{{item.rankName}}</option>
                    </template>
...
export default {
  data() {
    ...
    events: {
      ...
      submitInfo() {
        ...
        if (self.employeeID == "") {
          ...
          var copyInfo = {};
          copyInfo.employeeUser = this.info.employee;
          copyInfo.jobexperienceList = this.info.jobexperienceList;
          copyInfo.educateList = this.info.educateList;

          delete copyInfo.employeeUser.checkworkcode;
          delete copyInfo.employeeUser.checkworkid;
          delete copyInfo.employeeUser.checkWorkNo;

          delete self.extendList;
          self.employeeUser = self.employee;
          delete self.employee;
          store.actions.editEmployeeUser(copyInfo, function(data) {
            ...
            self.$parent.$refs.table.refresh();
            self.display = false;
          }, function(error) {
            self.$refs.spinner.hide();
            self.$root.showTip({
    ...
    ready() {
      ...
      if (self.employeeID != "") {
        //加载个人详细信息
        store.actions.loadEmployeeUserByID(self.employeeID, function(data) {
