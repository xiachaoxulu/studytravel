...
* @Last Modified time : 2016-11-24T16:05:10+08:00
 -->
...
<div style="background: #fff;">
    ...
    <div class="wrap">
        <ui-report v-ref:report :data-list="state.moveEmployeeNumberReportDataList" :titles="titles" :multi-titles="multiTitles" :row-total="rowTotal" :group-infos="groupColumns" :total-ignore='totalIgnore' :progress-show="processShow" :lorder="lorder" :td-height="70">
        </ui-report>
    </div>
        ...
        loadData(userName) {
            ...
            if (store.actions.checkConditions()) {
                if (self.state.flag) {
                    ...
                    store.actions.loadMoveEmployeeNumberReport(function(data) {
                        self.rowTotal = true;
            ...
            if (store.actions.checkConditions2()) {
                if (this.state.flag) {
                    ...
                    this.$nextTick(function() {
                        ...
                        window.location.href = Vue.__Basepath + 'acewill/common/exportMoveEmployeeNumberReport.htm?' + param;
                    })
                }
            }
        }
