...
* @Last Modified time : 2016-12-03T17:16:32+08:00
 -->
...
<div style="background: #fff;">
    ...
    <div class="wrap">
        <ui-report v-ref:report :data-list="state.attenXzyDayDataList" :titles="xzytitles" :multi-titles="multiTitles" :row-total="rowTotal" :group-infos="groupColumns" :total-ignore='totalIgnore' :td-height="70" :progress-show="processShow" :lorder="lorder">
        </ui-report>
    </div>
...
export default {
    data() {
        return {
            ...
            totalIgnore: ['date', 'userNum', 'middClockTime']
        }
    },
    methods: {
        //选择组织类型
        ...
        loadData() {
            ...
            if (this.userName) {
                ...
                if (self.state.flag) {
                    ...
                    store.actions.loadAtteXzyDayReportData(function(data) {
                        self.rowTotal = true;
            ...
            if (store.actions.checkConditions()) {
                if (this.state.flag) {
                    ...
                    this.$nextTick(function() {
                        ...
                        window.location.href = Vue.__Basepath + 'acewill/common/xzyExportDayAttendanceReport.htm?' + param;
                    })
                }
            }
        }
