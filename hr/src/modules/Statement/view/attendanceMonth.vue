...
* @Last Modified time : 2016-12-03T15:35:04+08:00
 -->
...
<div style="background: #fff;">
    ...
    <div class="wrap">
        <ui-report v-ref:report :data-list="state.attenMonthDataList" :titles="titles" :multi-titles="multiTitles" :row-total="rowTotal" :group-infos="groupColumns" :total-ignore='totalIgnore' :progress-show="processShow" :lorder="lorder" :td-height="70">
        </ui-report>
    ...
    methods: {
        ...
        loadData(userName) {
            ...
            if (userName) {
                ...
                store.actions.loadAtteMonthReportData(function(data) {
                    self.rowTotal = true;
            ...
            if (store.actions.checkConditions()) {
                if (this.state.flag) {
                    ...
                    this.$nextTick(function() {
                        ...
                        window.location.href = Vue.__Basepath + 'acewill/common/mwExportMonthAttendanceReport.htm?' + param;
                    })
                }
            }
        }
