...
* @Last Modified time : 2016-11-24T16:04:00+08:00
 -->
...
<div style="background: #fff;">
    ...
    <div class="wrap">
        <ui-report v-ref:report :column-total="true" :data-list="state.leaveEmployeeNumberReportDataList" :titles="state.leaveEmployeeNumberReportTitleList" :multi-titles="multiTitles" :row-total="rowTotal" :group-infos="groupColumns" :total-ignore='totalIgnore'
        ...
        loadData(userName) {
            ...
            if (store.actions.checkConditions()) {
                if (self.state.flag) {
                    ...
                    store.actions.loadLeaveEmployeeNumberReport(function(data) {
                        self.rowTotal = true;
            ...
            if (store.actions.checkConditions()) {
                if (this.state.flag) {
                    ...
                    this.$nextTick(function() {
                        ...
                        window.location.href = Vue.__Basepath + 'acewill/common/exportLeaveEmployeeNumberReport.htm?' + param;
                    })
                }
            }
        }
